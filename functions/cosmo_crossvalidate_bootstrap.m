function [pred, accuracy, test_chunks] = cosmo_crossvalidate(ds, classifier, partitions, opt, structNames, permutation, block)
...
% #   see the COPYING file distributed with CoSMoMVPA.           #
    ...
    for k=1:npartitions
        ...
        for i=1:npartitions-1
            parseTrain.(tempNames{i})=train_targets...
                (block(i).begin:block(i).end);
            
            if i==1
                newTargets = ...
                    parseTrain.(tempNames{i})(permutation.(tempNames{i}));
            else
