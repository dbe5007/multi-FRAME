...
#filelist = list.files(path = "/gpfs/group/nad12/default/nad12/facescene/RSA/models/unsmoothed/Encoding_Results_Trained_Novel_Run_MVPA", recursive = TRUE, pattern = "table.csv", full.names = TRUE)
